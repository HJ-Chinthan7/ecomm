    ...
    <>
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row">
          <aside className="bg-[#151515] p-3 mt-2 mb-2 w-full md:w-64 md:ml-20">
          ...
          <main className="p-3 flex-1">
            <h2 className="h4 text-center mb-2">{products?.length ?? 0} Products</h2>
            <div className="flex flex-wrap">
              {(!products || products.length === 0) && filteredProductsQuery.isLoading ? (
                <Loader />
